...
<%
	...
	<h4>Edit the Customer's Information</h4>
	<table>
	<form action="emp_profile_update.jsp" method="post">
			Enter the user name of customer info to be changed <input type="text" name="username"> <br>
			<br>
	...
	<h4>Edit the Customer's Information</h4>
	<table>
	<form action="emp_managereservation.jsp" method="post">
